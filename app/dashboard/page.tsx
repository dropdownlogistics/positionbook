...
const mockPositions = [
  { id: "1", symbol: "SNDK", strategy: "ORB", side: "LONG", status: "CLOSED", entryPrice: 48.20, exitPrice: 52.40, shares: 100, entryDate: "2026-03-06", rMultiple: 2.1, netPnl: 266, broker: "Tradier", fees: 1.00, exitSignal: "HOD_STOP", contextNote: "" },
...
export default function Dashboard() {
  ...
  const kpis = [
    { label: "Total Positions", value: String(mockPositions.length), color: "#e8f0f7" },
    ...
    <div style={s.page}>
      ...
      {showForm && (
        <div style={{ backgroundColor: "#0d1c2a", border: "1px solid #1a3044", borderRadius: "10px", padding: "24px", marginBottom: "24px" }}>
          <div style={{ color: "#3d6480", fontSize: "12px", textTransform: "uppercase" as const, letterSpacing: "0.08em" }}>Log Position - coming next session</div>
        </div>
      )}
